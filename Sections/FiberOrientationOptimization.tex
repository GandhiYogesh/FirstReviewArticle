...
a level set function to represent curvilinear fiber paths \cite{Brampton2015}, thus naturally ensuring fiber continuity and being often
parallel to the neighboring fiber paths. However, the optimization result
...
level.
\subsection*{Heurstic-based approaches}
